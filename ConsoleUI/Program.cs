    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            Car explorer = new Car() { HasTrunk = true, Make = "Ford", Model = "Explorer", Year = 2019 };
            Motorcycle harley = new Motorcycle() { HasTwoWheels = true, Make = "Harley Davidson", Model = "fatback", Year = 2017 };
            Vehicle sedan = new Car() { HasTrunk = true, Make = "Honda", Model = "Accord", Year = 2020 };
            Vehicle sportsCar = new Car() { HasTrunk = false, Make = "Rolls Royce", Model = "Phantom", Year = 2015 };
